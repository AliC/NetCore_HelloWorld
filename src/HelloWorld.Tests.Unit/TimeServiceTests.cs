...
namespace HelloWorld.Tests
{
    public class TimeServiceTests
    {
        ...
        [Fact]
        public void Returns_Correctly_Formatted_Time_When_Minutes_Under_Ten_And_Hours_Under_Ten_And_Before_Noon()
        {
            var now = new DateTime(2017, 10, 14, 5, 3, 0);
            var timeService = new TimeService(now);
            var expectedTime = "5:03 AM";
        ...
        [Fact]
        public void Returns_Correctly_Formatted_Time_When_Minutes_Over_Nine_And_Hours_Over_Nine_And_After_Noon()
        {
            var now = new DateTime(2017, 10, 14, 22, 35, 0);
            var timeService = new TimeService(now);
            var expectedTime = "10:35 PM";
